...
| [game-visual-effects](./game-visual-effects.md) | 游戏表现技术方案调研报告 - 2D地图/3D战斗场景的程序化实现，着色器/粒子系统/后处理技术 |
...
- 每个调研报告使用独立目录
- 目录命名使用 kebab-case（如 `skill-creator-research`）
- README 使用表格展示调研进度
...
6. **优缺点分析** - 优势与不足
7. **平替对比** - 对比其他类似的产品或工具
8. **落地过程** - 实践验证的完整记录（包括本地测试）

### 补充信息

9. **使用场景** - 具体什么情况下会用
10. **适合人群** - 开发者/团队/个人
11. **成本评估** - 免费还是付费、API 费用
12. **学习曲线** - 新手上手难度
13. **维护状态** - 是否在积极维护、最后更新时间
14. **社区活跃度** - Star 数、Issue 活跃度、贡献者数量
